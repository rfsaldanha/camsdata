...
# Folders
original_unit_folder <- "/dados2/data/cams/cams_2003_2024/cams_o3/"
new_unit_folder <- "/dados2/data/cams/cams_2003_2024/cams_o3_mc/"
...
gas_fun <- function(df_list, dest) {
  ...
  writeCDF(
    ...
    filename = path(
      dest,
      paste0("cams_o3_mc_", format(ymd(date), "%Y%m%d"), ".nc")
    ),
    varname = "o3",
