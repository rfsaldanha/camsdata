...
if (dbExistsTable(con, "o3_max_mean")) {
  dbRemoveTable(con, "o3_max_mean")
}
if (dbExistsTable(con, "o3_min_mean")) {
  dbRemoveTable(con, "o3_min_mean")
}

dbListTables(con)

# Folders
daily_data_folder <- "/media/raphaelsaldanha/lacie/cams_o3_daily_agg/"
...
dbExecute(
  con,
  "COPY (SELECT * FROM 'o3_mean_mean') TO 'o3_mean_mean.parquet' (FORMAT 'PARQUET')"
)

dbExecute(
  con,
  "COPY (SELECT * FROM 'o3_max_mean') TO 'o3_max_mean.parquet' (FORMAT 'PARQUET')"
)

dbExecute(
  con,
  "COPY (SELECT * FROM 'o3_min_mean') TO 'o3_min_mean.parquet' (FORMAT 'PARQUET')"
)

# Export CSV file
dbExecute(
  con,
  "COPY (SELECT * FROM 'o3_mean_mean') TO 'o3_mean_mean.csv' (FORMAT 'CSV')"
)

dbExecute(
  con,
  "COPY (SELECT * FROM 'o3_max_mean') TO 'o3_max_mean.csv' (FORMAT 'CSV')"
)

dbExecute(
  con,
  "COPY (SELECT * FROM 'o3_min_mean') TO 'o3_min_mean.csv' (FORMAT 'CSV')"
)
