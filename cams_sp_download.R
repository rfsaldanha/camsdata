...
# Parameters
# dir_data <- "/media/raphaelsaldanha/lacie/cams_sp"
# dir_data <- "/dados2/data/cams/cams_sp"
dir_data <- "/dados2/data/cams/cams_2003_2024/cams_sp"
...
# Download loop
for (d in dates) {
  cli_h1(glue("CAMS surface pressure {d}"))

  # File name
  file_name <- glue(
    "cams_sp_{substr(d,0,4)}{substr(d,6,7)}{substr(d,9,10)}.nc"
  )
