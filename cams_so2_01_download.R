...
# Parameters
# dir_data <- "/media/raphaelsaldanha/lacie/cams_so2"
dir_data <- "/dados2/data/cams/cams_2003_2024/cams_so2"
# dir_data <- "~/Downloads/cams/cams_so2"
...
for (d in dates) {
  cli_h1(glue("CAMS SO2 {d}"))

  file_name <- glue(
    "cams_so2_{substr(d,0,4)}{substr(d,6,7)}{substr(d,9,10)}.nc"
  )
